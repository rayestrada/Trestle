 ...
 */
function trestle_form_system_theme_settings_alter(&$form, $form_state, $form_id = NULL) {
  ...
  $form['themedev']['trestle_rebuild_registry'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Rebuild theme registry on every page.'),
    '#default_value' => theme_get_setting('trestle_rebuild_registry'),
